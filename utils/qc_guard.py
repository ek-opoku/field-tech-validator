...
SANITY_LIMITS = {
    ...
    "dissolved_oxygen_mg_l": {"min": 0.0, "max": 20.0, "name": "Dissolved Oxygen (mg/L)"},
    "dissolved_oxygen_sat": {"min": 0.0, "max": 230.0, "name": "Dissolved Oxygen (% saturation)"},
    "nitrate": {"min": 0.0, "max": 45.0, "name": "Nitrate, dissolved (mg/L as N)"},
    "nitrite": {"min": 0.0, "max": 1.0, "name": "Nitrite, dissolved (mg/L as N)"},
    "orthophosphate": {"min": 0.0, "max": 1.5, "name": "Phosphate, dissolved (mg/L as P)"},
...
def load_historical_bounds(schema_csv_path: Path) -> Dict[str, Dict[str, Dict[str, float]]]:
    ...
    header_map = {
        ...
        "Dissolved Oxygen (% saturation)": "dissolved_oxygen_sat",
        "Nitrate, dissolved (mg/L as N)": "nitrate",
        "Nitrite, dissolved (mg/L as N)": "nitrite",
        "Phosphate, dissolved (mg/L as P)": "orthophosphate",
